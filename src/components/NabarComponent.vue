<template>
      ...
      <div class="col-lg-6 text-center text-lg-right">
        <div class="d-inline-flex align-items-center">
          <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right"  v-if="!loggedId">
              <button class="dropdown-item" @click="showModal = true" type="button" >
                Sign in
              </button>
  ...
  <LoginModal v-show="showModal" @close="closeModal" >
